<?php
    ...
    if($result_id){
        ...
        if(isset($dados_sintoma['nome_cientifico_comp'])){
            ...
            $sql = "INSERT INTO tb_sintomas (nome_cientifico, nome_popular, causas, tratamentos, id_parte_corpo, nome_cientifico_comp, id_status, comentarios, id_user)

            VALUES ('$nome_c', '$nome_p', '$causa', '$tratamento', $parte_corpo, '$nome_comp','1', 'Planta enviado para aprovação do responsável', '$id_usuario')";
